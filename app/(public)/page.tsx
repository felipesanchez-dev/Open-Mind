          ...
          <div className="w-full text-center max-w-4xl mx-auto">
            <div className="space-y-3 sm:space-y-4 md:space-y-6">
              <div className="flex justify-center animate-fade-in-up">
                <Badge
                  variant="outline"
                  className="px-3 py-1.5 text-xs bg-gradient-to-r from-primary/10 to-secondary/10 border-primary/20 hover:from-primary/20 hover:to-secondary/20 transition-all duration-500 cursor-pointer group backdrop-blur-sm"
                >
                  <span className="">Aprende a tu ritmo en</span>
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center items-center animate-fade-in-up animation-delay-600 px-4">
                ...
                {session ? (
                  ...
                  >
                    {isSigningOut ? (
                      <>
                        <div className="w-4 h-4 mr-2 animate-spin rounded-full border-2 border-primary/30 border-t-primary" />
